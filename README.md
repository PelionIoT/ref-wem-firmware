...
Login to the mbed cloud protal and copy your mbed cloud API key. Paste that one-line string into a new file called `.mbed-cloud-key` in the same main directory as the rest of the project. For more information, see [Downloading a developer certificate](#GetDevCert).
